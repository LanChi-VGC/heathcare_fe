...
import Admins from "./admin/adminllist";
...
const routes = [
    ...
    {path: "/editservice/:id" , exact : true,name: "EditServices",component:EditService},
    {path: "/majorlist" , exact : true,name: "Majors",component:Majors},
    {path: "/addmajor" , exact : true,name: "Majors",component:AddMajor},
    {path: "/editmajor/:id" , exact : true,name: "EditMajor",component:EditMajor},
    ...
    {path: "/editarea/:id" , exact : true,name: "EditAreas",component:EditArea},
    ...
    {path: "/editnursing/:id" , exact : true,name: "EditNursing",component:EditNursing},
    {path: "/tiplist" , exact : true,name: "Tips",component:Tips},
    {path: "/addtip" , exact : true,name: "AddTip",component:AddTip},
    {path: "/edittip/:id" , exact : true,name: "EditTip",component:EditTip},
    ...
    {path: "/editlicense/:id" , exact : true,name: "EditLicense",component:EditLicense},
    {path: "/adminlist", exact : true,name: "Admins",component:Admins},
    {path: "/addadmin" , exact : true,name: "Addadmin",component:AddAdmin},
    {path: "/editadmin/:id" , exact : true,name: "EditAdmin",component:EditAdmin},
