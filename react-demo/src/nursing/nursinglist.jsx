                ...
                <div class="page-wrapper">
                    <div class="content">
                        <div class="row">
                            ...
                            <Link to="/addnursing" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Thêm điều dưỡng</Link>
                            </div>
                        </div>
				        <div class="row">
					        <div class="col-md-12">
                                             ...
                                             <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <Link class="dropdown-item" to="/editnursing"><i class="far fa-edit m-r-5"></i>Sửa</Link>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-body text-center">
                                    ...
                                    <h3>Bạn có chắc muốn xóa điều dưỡng này ?</h3>
